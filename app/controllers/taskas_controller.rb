  ...
  def crt_bill
    ...
    par[:cls].each do |k,v|
      if v == "1" || par[:all] == "1"
        ...
        end #END payment dont exist

      end #end v==1
    end #end pars[:cls]
    flash[:notice] = "#{no_bill} bills created successfully"
    redirect_to tsk_fee_path(@taska, sch_mth: par[:mth] ,sch_yr: par[:yr], shw: true )
  end
